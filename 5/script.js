...
// 3 Создать переменную last_elem и передать в нее последний элемент из сформированного массива numbers_squared (обратиться к элементу массива по индексу)
// let numbers_squared = [1, 4, 9, 16, 25];
// let last_elem = numbers_squared[numbers_squared.length - 1];

// console.log(last_elem); // Выводит 25
...
const user = {
  ...
  const message = `User's name is ${first_name} ${last_name}. He is ${age} years old.`;
